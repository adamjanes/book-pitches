...
- Read openspec/changes/magic-link-auth/tasks.md for the current task list
- Read openspec/changes/magic-link-auth/design.md for technical decisions
- Read openspec/changes/magic-link-auth/specs/magic-link-auth/spec.md for requirements
...
- If you encounter ambiguity, check openspec/changes/magic-link-auth/ for the relevant specs and design docs, check existing code patterns, and make the simplest choice that works.
...
- Update openspec/changes/magic-link-auth/tasks.md to mark the task `[x]` done.
- Then exit.
