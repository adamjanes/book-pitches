...
- [x] 4.1 Configure magic link email template via Supabase Management API — branded parchment-tone template with "Your Book Pitches sign-in link" subject
...
- [x] 5.3 Test full flow: enter email → check-email screen → click link in email → authenticated and redirected — verified manually
